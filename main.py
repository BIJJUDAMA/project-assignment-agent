"""
Main orchestration pipeline for the project assignment agent.

Entry point logic: PDF → parse → GitHub → evaluate → score → CSV output.
Run via:
    python main.py <pdf_path>
    python main.py --resumes <path> --projects <path>
"""
...
from pipeline.pdf_handler import PDFHandler
from pipeline.github import fetch_and_display_github_info
from schemas.resume import JSONResume, EvaluationData, ProjectRequirements, ProjectFit
from pipeline.evaluator import ResumeEvaluator
from pipeline.match_evaluator import MatchEvaluator
