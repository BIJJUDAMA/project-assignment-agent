"""
PDF extraction pipeline: converts a PDF resume into a JSONResume object
using PyMuPDF for text extraction and Ollama for structured parsing.
"""
...
from hiring_agent.schemas.resume import (
    JSONResume,
    Basics,
    Work,
    Education,
...
from hiring_agent.utils.transform import transform_parsed_data
...
class PDFHandler:
    ...
    def _call_llm_for_section(
        ...
        try:
            ...
            # Use the Ollama provider to make the API call
